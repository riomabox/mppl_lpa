        ...
        <?php /*if (empty($query->result)) {
         ...
         <tr>
          ...
          <td>
           ...
           <a href="<?php echo base_url(); ?>/kelas/detail_kelas/<?php echo $k->id_kelas; ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-search"> Detail</i></a>
           <a href="<?php echo base_url(); ?>/kelas/hapus/<?php echo $k->id_kelas; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')"><i class="glyphicon glyphicon-trash"> Hapus</i></a>
          </td>
         </tr>
        <?php $numb++;}?>
        </tbody>
